...
public class ChairBlock extends HorizontalFacingBlock {
    ...
    public @Nullable BlockState getPlacementState(ItemPlacementContext ctx) {
        // Makes chair place facing the player (North in block bench is forward)
        return this.getDefaultState().with(FACING, ctx.getHorizontalPlayerFacing().getOpposite()); //.with gives properties?
    }
