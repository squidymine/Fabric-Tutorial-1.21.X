...
// Handles screen/inventory interactions (i.e. hovering over items, inserting items, etc.)
public class PedestalScreenHandler extends ScreenHandler {
    ...
    @Override
    public ItemStack quickMove(PlayerEntity player, int invSlot) { // Shift left click ability, could mess with this later
