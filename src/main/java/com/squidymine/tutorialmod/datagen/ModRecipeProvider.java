    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup wrapperLookup, RecipeExporter recipeExporter) {
        return new RecipeGenerator(wrapperLookup, recipeExporter) {
            ...
            public void generate() {
                ...
                createShapeless(RecipeCategory.REDSTONE, ModBlocks.PINK_GARNET_BUTTON, 1)
                ...
                offerSlabRecipe(RecipeCategory.DECORATIONS, ModBlocks.PINK_GARNET_SLAB, ModBlocks.PINK_GARNET_BLOCK);
                offerWallRecipe(RecipeCategory.DECORATIONS, ModBlocks.PINK_GARNET_WALL, ModBlocks.PINK_GARNET_BLOCK);
                ...
                createShaped(RecipeCategory.TOOLS, ModItems.PINK_GARNET_AXE)
                        ...
                        .input('S', Items.STICK)
                        .criterion(hasItem(ModItems.PINK_GARNET), conditionsFromItem(ModItems.PINK_GARNET))
                        .offerTo(recipeExporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(TutorialMod.MOD_ID, "pink_garnet_axe_reversed")));
                ...
                createShaped(RecipeCategory.TOOLS, ModItems.PINK_GARNET_HOE)
                        ...
                        .input('S', Items.STICK)
                        .criterion(hasItem(ModItems.PINK_GARNET), conditionsFromItem(ModItems.PINK_GARNET))
                        .offerTo(recipeExporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(TutorialMod.MOD_ID, "pink_garnet_hoe_reversed")));
